...
export interface IChatRepository {
  ...
  createChat(data: { type: ChatType; name?: string | null; avatarUrl?: string | null }): Promise<Chat>;
...
export interface IChatController {
  ...
  getMessages(payload: { chatId: string; userId: string; skip?: number; take?: number }): Promise<Message[]>;
