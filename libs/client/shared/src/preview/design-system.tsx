  ...
  return (
    <div className="min-h-screen bg-surface text-text p-10 font-sans transition-colors duration-200">
      ...
      <section className="mb-10">
        <h2 className="text-xs font-semibold uppercase tracking-widest text-text-muted mb-4">Purple Shades</h2>
      ...
      {/* White shades */}
      <section className="mb-10">
        <h2 className="text-xs font-semibold uppercase tracking-widest text-text-muted mb-4">White Shades</h2>
        <div className="flex flex-wrap gap-3">
          {[
      ...
      {/* Gray shades */}
      <section className="mb-10">
        <h2 className="text-xs font-semibold uppercase tracking-widest text-text-muted mb-4">Gray Shades</h2>
        <div className="flex flex-wrap gap-3">
          {[
            ['bg-black',   '#000000', '00'],
      ...
      {/* Semantic tokens */}
      <section className="mb-10">
        <h2 className="text-xs font-semibold uppercase tracking-widest text-text-muted mb-4">Semantic Tokens</h2>
        <div className="flex flex-wrap gap-3">
          {[
            ['bg-primary',          'primary'],
            ['bg-surface',          'surface'],
      ...
      {/* Typography */}
      <section className="mb-10">
        <h2 className="text-xs font-semibold uppercase tracking-widest text-text-muted mb-4">Typography</h2>
        <div className="space-y-4">
          ...
          <div className="pt-4 border-t border-border space-y-1">
            <p className="text-xs text-text-muted mb-2 uppercase tracking-widest">Override & sr-only</p>
            <div className="flex items-baseline gap-4">
              <span className="text-[10px] text-text-muted w-16">h1 as h3</span>
              <Heading level={3} as="h1">Looks like h3, tag is h1</Heading>
            </div>
            <div className="flex items-center gap-4">
              <span className="text-[10px] text-text-muted w-16">sr-only</span>
              <span className="text-sm text-text-muted italic">[ невидим — только для скринридеров ]</span>
              <Heading level={2} srOnly>Hidden heading for screen readers</Heading>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Buttons */}
      <section className="mb-10">
        <h2 className="text-xs font-semibold uppercase tracking-widest text-text-muted mb-4">Buttons</h2>
        <div className="flex flex-wrap gap-3">
      ...
      {/* Surfaces */}
      <section>
        <h2 className="text-xs font-semibold uppercase tracking-widest text-text-muted mb-4">Surfaces</h2>
        <div className="flex gap-3">
          <div className="bg-surface border border-border rounded-lg p-4 text-sm">surface</div>
          <div className="bg-surface-elevated border border-border rounded-lg p-4 text-sm">surface-elevated</div>
        </div>
      </section>
    </div>
  );
